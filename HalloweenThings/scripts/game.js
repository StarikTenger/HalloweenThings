...
// Generates the map
    generate() {
        ...
        for (let i = 0; i < this.monsters.length; i++) {
            ...
            if (this.checkCell(monster.gridPos) || this.grid[monster.gridPos.x][monster.gridPos.y].light <= 0 || monster.hp <= 0 || monster.pos.dist(this.player.pos) > DIST_LOAD * 8 * 2) {
                // Drop items
        ...
        for (let i = 0; i < this.subjects.length; i++) {
            ...
            if (this.checkCell(subject.gridPos) || this.grid[subject.gridPos.x][subject.gridPos.y].light <= 0 || !subject.type || subject.pos.dist(this.player.pos) > DIST_LOAD * 8 * 2) {
